...
const Nav = () => {
  return (
    <nav className="nav">
      ...
      <li className="nav_item"><a href="#" className="nav_link">Partners</a></li>
      <li className="nav_item"><a href="#" className="nav_link">Stories</a></li>
      </ul>
      <button className="nav_downloadBtn">Download for free</button>
    </nav>
  );
};
